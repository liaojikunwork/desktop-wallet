export default {
  ...
  INTRODUCTION: {
    WELCOME: {
      ...
      SAFETY_MESSAGE:
        'Please take a few moments to read the next few screens for your own safety.',
      FUNDS_WARNING:
        'Your funds could be unrecoverable if you do not pay close attention to these warnings.'
    },
    POWER: {
      TITLE: 'Your Power',
      FINANCE:
        'The most important thing for users to know about cryptocurrencies is that they completely reverse the commonly-accepted model of how finance works.',
      BANKS:
        'In traditional finance, you give up direct control of your money to a bank. Because banks have control over your money, they can take actions on your behalf, such as refunding transactions and resetting your login info.',
      CRYPTO:
        'Cryptocurrencies take that power and give it to you directly. Using nothing more than your passphrase, you can control exactly when, where and how your money is kept and spent.',
      RESPONSIBILITY:
        'However, in the words of Uncle Ben Parker, with great power comes great responsibility.'
    },
    DUTY: {
      TITLE: 'Your Duty',
      CONTROL:
        'The blockchain industry is built to be censorship resistant. That means no one controls your account but you. This design brings the peace of mind that no central authority can confiscate, freeze, or manipulate your funds at any time. There is also no central location for personal data or funds to be hacked.',
      OWNER:
        'This also brings greater responsibility for you, the account owner.',
      WARNING: {
        ACCOUNT: 'Unlike your traditional bank account, {CANNOT_RESTORE}.',
        CANNOT_RESTORE:
          'lost passwords, passphrases or stolen funds cannot be restored by the delegates, ARK.io team, or anyone else'
      },
    ...
    RESPONSIBILITY: {
      ...
      BACKUP: {
        ...
        OPTIONS:
          'You can write it down on thick paper and store multiple copies in secure locations. You can also store it on an encrypted flash drive. Alternatively, you can use a Ledger Nano S USB hardware device, available at Ledger.com, to store and access your funds and the ARK Desktop Wallet. You can plug your Ledger Nano S into your computer and access the ARK blockchain without needing to enter your passphrase.'
      },
      REMEMBER:
        'Remember, anyone who has your passphrase can access your funds. Never share your account with anyone and avoid storing it in locations that are susceptible to hacks, such as the Cloud.'
    },
    TURN: {
      TITLE: 'Your Turn',
      KNOWLEDGE:
        'Now, armed with the knowledge of how important it is to keep your passphrases safe, you are ready to claim your financial autonomy with the ARK Desktop Wallet.',
      SUPPORT:
        'ARK is an open-source ecosystem and if you need assistance, the ARK community and team is here to help. Create a post on reddit.ark.io, or join the real-time chat system at slack.ark.io.',
      CONCLUSION:
        'Everyone here on the ARK.io team hopes you enjoy using the ARK Desktop Wallet to participate in the blockchain revolution!'
    }
  },
  ...
  VALIDATION: {
    ...
    NAME: {
      ...
      EXISTS_AS_CONTACT:
        "The name '{0}' has already been assigned to a contact",
      EXISTS_AS_WALLET: "The name '{0}' has already been assigned to a wallet",
      MAX_LENGTH: 'The name should have less than {0} characters.',
      MIN_LENGTH:
        'The name should have at least 1 character | The name should have at least {n} characters.'
    },
    PASSWORD: {
    ...
    ADDRESS: {
      EXISTS_AS_CONTACT:
        "The address '{0}' has already been added as a contact",
      EXISTS_AS_WALLET:
        "The address '{0}' has already been imported as a wallet"
    },
    PUBLIC_KEY: {
    ...
    RECIPIENT_DIFFERENT_NETWORK:
      'The recipient {0} belongs to a different network',
  ...
  APP_SIDEMENU: {
    ...
    SETTINGS: {
      ...
      SCREENSHOT_PROTECTION: {
        ...
        NOTE:
          'This feature enables applications to protect their own onscreen window content from being captured or copied though screenshot utilities.',
      ...
      RESET_DATA: {
        ...
        NOTE:
          'All your data, including profiles, wallets, networks and contacts will be removed from the app and reset to default. The data, such as transactions, that are on the blockchain cannot be removed.'
      },
      THEME: 'Theme'
    },
    WALLETS: 'My wallets'
  ...
  APP_UPDATER: {
    ...
    NETWORK_ERROR:
      "Looks like your file isn't downloading. Verify your connection."
  },
  ...
  INPUT_DELEGATE: {
    ERROR: {
      ...
      ADDRESS_NOT_FOUND:
        "The delegate with the address '{0}' could not be found",
      PUBLIC_KEY_NOT_FOUND:
        "The delegate with the public key '{0}' could not be found"
    },
  ...
  INPUT_FEE: {
    ...
    ADVANCED_NOTICE:
      'Be careful what fee you choose as it will cost more than necessary if too high',
  ...
  MODAL_ADDITIONAL_LEDGERS: {
    CANCEL: 'Cancel',
    INFO:
      'Choose the max amount of Ledger wallets you would like to show. You are currently showing {quantity} wallets.',
    LARGE_QUANTITY:
      'You are trying to load a large number of wallets. This could result in slow loading or the device could timeout.',
    LOAD: 'Load Wallets',
    QUANTITY: 'Quantity',
  ...
  MODAL_EXPORT_WALLETS: {
    ...
    INSTRUCTIONS:
      'Your exported wallets will not contain your passphrases, only the addresses and respective names will be saved!',
    OPTIONS: {
  ...
  MODAL_QR_SCANNER: {
    ERROR: {
      ...
      NOT_READABLE:
        'We are unable to read the camera stream, maybe it is already in use?',
      OVERCONSTRAINED:
        'It seems that we were unable to find a correct camera. This might be an issue with the constraints we expect.',
      STREAM:
        'It seems that you are using an unsupported browser. That is very curious..'
    },
  ...
  MODAL_LOADER: {
    CLOSE_WARNING:
      'It looks like something went wrong. You may close the window but this could cause adverse effects.'
  },
  ...
  MODAL_NETWORK: {
    ...
    NETWORK_IN_USE:
      'This network is in use by one or more profiles and cannot be removed',
    DEFAULT_NETWORK_NO_DELETE:
      'This is a default network and cannot be deleted',
  ...
  PAGES: {
    CONTACT_ALL: {
      ...
      INSTRUCTIONS:
        'This page allows you to create contacts, making it easier for you to work with addresses by giving them an identifiable name',
      HEADER: 'My contacts',
    ...
    CONTACT_NEW: {
      INSTRUCTIONS: {
        HEADER: 'New contact',
        TEXT:
          'Enter the address of your contact. You will be able to view its transactions'
      },
      ...
      NAME_INFO: 'Info:',
      NAME_DESCRIPTION:
        'Contact name is not required, but it can be used for your convenience',
    ...
    PROFILE_NEW: {
      ...
      STEP2: {
        ...
        CUSTOM_NETWORK_EXPLAIN:
          'You can select your custom network or choose any of the available networks.',
        NAME: 'Profile name',
        TITLE: '2. Network'
      },
      STEP3: {
        INSTRUCTIONS: {
          HEADER: 'Appearance',
          TEXT:
            'Customize this application by selecting one of our themes and backgrounds.'
        },
        MARKET_CHART:
          'Choose to display the price chart on the dashboard or not',
        THEME: 'Choose theme',
    ...
    PROFILE_EDITION: {
      ...
      TAB_PROFILE: {
        INSTRUCTIONS: {
          ...
          TEXT:
            'Here you can modify your name or nickname, select your preferred language and default currency, the network and avatar.'
        },
        TITLE: 'Profile'
      },
      TAB_DESIGN: {
        INSTRUCTIONS: {
          ...
          TEXT:
            'Here you can choose the default theme (light or dark) and the background.'
        },
        TITLE: 'Wallet design'
      }
    },
    ...
    WALLET_EXCHANGE: {
      CHANGELLY_TERMS: {
        TITLE:
          'Purchase {ticker} directly within ARK Desktop Wallet with our Changelly integration',
        CONTENT:
          'Changelly lets you exchange other cryptocurrencies into {ticker} and has an option to buy {ticker} directly with your credit or debit cards.',
        CONFIRMATION:
          'I have read and I agree with the {terms} and the {privacy} from Changelly. By clicking {button}, I acknowledge and understand that my transaction may trigger AML/KYC verification according to Changelly {kyc}.',
    ...
    WALLET_ALL: {
      LEDGER: {
        ...
        CACHE_INFO:
          'Cache wallets from your ledger to speed up loading when first connected',
    ...
    WALLET_IMPORT: {
      STEP1: {
        INSTRUCTIONS: {
          ...
          TEXT:
            'Fill in the passphrase of your wallet. You can fill in the address first, to ensure that it matches the given passphrase.'
        },
      ...
      STEP2: {
        INSTRUCTIONS: {
          ...
          TEXT:
            'Enter a password you would like to use in order to encrypt your passphrase.'
        },
        TITLE: '2. Encryption',
    ...
    WALLET_NEW: {
      STEP1: {
        INSTRUCTIONS: {
          HEADER: 'New wallet',
          TEXT_BEFORE_BUTTON:
            'Select one of these freshly generated wallets. If you do not like them, click on the',
      ...
      STEP2: {
        INSTRUCTIONS: {
          ...
          TEXT:
            'Be sure to save your passphrase securely. Do not show this passphrase to anyone.'
        },
        TITLE: '2. Backup'
      },
      STEP3: {
  ...
  PROFILE_LEAVING_CONFIRMATION: {
    QUESTION:
      'Are you sure you want to ignore the changes done to this profile?',
    NO: 'No, save them',
    YES: 'Yes, ignore them'
  },
  ...
  PROFILE_REMOVAL_CONFIRMATION: {
    NOTE:
      'Although it would remove your wallets, it does not delete any data on the blockchain. You could recover the wallets as long as you have their passphrases',
  ...
  TRANSACTION: {
    ...
    ERROR: {
      ...
      FEE_TOO_LOW:
        'Transaction could not be sent because the fee ({fee}) is too low',
      NOTHING_SENT:
        'The transaction could not be sent. Please check your network connection or change peer',
    ...
    INFO: {
      ...
      BROADCASTING_SLOW:
        "It looks like it's taking a while to broadcast your transaction. You may close the window and it will continue to send in the background."
    },
    SUCCESS: {
    ...
    WARNING: {
      BROADCAST:
        'Transaction was broadcasted to other peers. It may not be accepted by them'
    },
    AMOUNT: 'Amount',
    BLOCK_ID: 'Block ID',
    CONFIRMATION_COUNT: '{confirmations} Confirmations',
    CONFIRM_SEND_ALL:
      'This will enable sending all of your tokens from the current wallet in this transaction.',
    ...
    ID: 'ID',
    LEDGER_SIGN_NOTICE:
      'Next you will confirm the transaction with your Ledger',
    LEDGER_SIGN_WAIT:
      'Awaiting Ledger Signature. Please check and sign the transaction when you are ready.',
  ...
  SIGN_VERIFY: {
    ...
    FORMAT_FOOTER:
      'Format (JSON): { "publicKey": "...", "signature": "...", "message": "..." }',
  ...
  SYNCHRONIZER: {
    ...
    NEW_DELEGATE_REGISTRATION:
      'New delegate: {address} registered as {username}',
    NEW_VOTE: 'New vote: {address} {voteUnvote} {publicKey}',
    NEW_TRANSFER_SENT:
      'New transfer: {amount} sent from {sender} to {recipient}',
    NEW_TRANSFER_RECEIVED:
      'New transfer: {amount} received from {sender} to {recipient}'
  },
  ...
  WALLET_HEADING: {
    ...
    PENDING_BALANCE:
      '{amount} including 1 unconfirmed transaction | {amount} including {n} unconfirmed transactions',
  ...
  WALLET_SECOND_SIGNATURE: {
    ...
    ALREADY_REGISTERED:
      'There is already a second passphrase registered for this address',
    INSTRUCTIONS:
      'You will need both 12 word passphrases to interact with the network. Keep them safe!'
  },
  ...
  WALLET_DELEGATES: {
    ...
    VOTE_INFO: 'Info:',
    NO_VOTE:
      'This wallet is not voting. To view more information and vote, use the search or click on any delegate',
  ...
  WALLET_REMOVAL_CONFIRMATION: {
    NOTE:
      'It does not delete any data on the blockchain. You could recover the wallet as long as you have the passphrase',
  ...
  WALLET_TRANSACTIONS: {
    ...
    AMOUNT: 'Amount',
    NEW_TRANSACTIONS:
      '0 | This wallet has 1 new transaction. Press the refresh button to update. | This wallet has {count} new transactions. Press the refresh button to update.'
  },
